...
void mm_1_1idx(double *m1, double *m2, double *m3, int a, int b, int c) {
    double *ma, *mb, *mc;
...
void mm_1_transp_1idx(double *m1, double *m2, double *m3, int a, int b, int c) {
    double T[c*b];
    double *ma, *mb;
    int t1,t2;
...
void mm_1_transp_1idx_unroll2(double *m1, double *m2, double *m3, int a, int b, int c) {
    double T[c*b];
    double *ma, *mb;
    int t1,t2;
...
void mm_1_transp_1idx_unroll4(double *m1, double *m2, double *m3, int a, int b, int c) {
    double T[c*b];
    double *ma, *mb;
    int t1,t2;
...
void mm_1_transp_1idx_unroll8(double *m1, double *m2, double *m3, int a, int b, int c) {
    double T[c*b];
    double *ma, *mb;
    int t1,t2;
...
void mm_1_transp_1idx_sse2(double *m1, double *m2, double *m3, int a, int b, int c) {
    double T[c*b];
    __m128d *ma, *mb;
    int t1,t2;
...
void mm_1_transp_1idx_sse2_cache(double *m1, double *m2, double *m3, int a, int b, int c) {
    double *T;
    posix_memalign((void **) &T, 16, c*b*sizeof(double));
    __m128d *ma, *mb, mt;
    double *mc;
    int t1,t2;
...
void mm_1_kij_sse2_cache(double *m1, double *m2, double *m3, int a, int b, int c) {
    __m128d ma, *mb, mt;
    double *mc, *m1chunk;
...
/*void potente(double **mul1, double **mul2, double **res, int N) {
    int i, i2, j, j2, k, k2;
...
void mm_1_kij_unroll2(double *m1, double *m2, double *m3, int a, int b, int c) {
    double *mb;
...
void mm_1_kij_unroll4(double *m1, double *m2, double *m3, int a, int b, int c) {
    double *mb;
...
void mm_1_kij_unroll8(double *m1, double *m2, double *m3, int a, int b, int c) {
    double *mb;
...
void mm_1_kij_sse2_unroll2(double *m1, double *m2, double *m3, int a, int b, int c) {
    __m128d ma, *mb, *mc = (__m128d *) m3;
    int t1,t2;
...
void mm_1_kij_sse2_unroll4(double *m1, double *m2, double *m3, int a, int b, int c) {
    __m128d ma, *mb, *mc = (__m128d *) m3;
    int t1,t2;
...
void mm_1_transp_1idx_sse2_unroll2(double *m1, double *m2, double *m3, int a, int b, int c) {
    double T[c*b];
    __m128d *ma, *mb;
    int t1,t2;
...
void mm_1_transp_1idx_sse2_unroll4(double *m1, double *m2, double *m3, int a, int b, int c) {
    double T[c*b];
    __m128d *ma, *mb;
    int t1,t2;
...
int main(int argc, char *argv[]) {
    ...
    double *m2;
    double *m3;
    posix_memalign((void **) &m1, 16, a*b*sizeof(double));
    posix_memalign((void **) &m2, 16, b*c*sizeof(double));
    posix_memalign((void **) &m3, 16, a*c*sizeof(double));

    if (fi) {
        int t = fread(m1, sizeof(double), a*b, fi);
        ERROR( t!=a*b , "can't read m1\n" );
        t = fread(m2, sizeof(double), c*b, fi);
    ...
    memset(m3, 0, a*c*sizeof(double));
    
    double **mm1 = (double **) malloc(a*sizeof(double *));
    double **mm2 = (double **) malloc(a*sizeof(double *));
    double **mm3 = (double **) malloc(a*sizeof(double *));
    
    for (int t=0; t<a; t++) {
        posix_memalign((void **) &(mm1[t]), 64, a*sizeof(double));
        for (int t2=0; t2<a; t2++) mm1[t][t2]=t*a + t2;
        posix_memalign((void **) &(mm2[t]), 64, a*sizeof(double));
        mm2[t][t]=1;
        posix_memalign((void **) &(mm3[t]), 64, a*sizeof(double));
        memset(mm3[t], 0, a*sizeof(double));
    }
